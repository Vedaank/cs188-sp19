    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for newPos in newPosDist:
                beliefs[newPos] += self.beliefs[oldPos] * newPosDist[newPos]
        beliefs.normalize()
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for partPos in self.particles:
            pacmanPos = gameState.getPacmanPosition()
            jailPos = self.getJailPosition()
            beliefs[partPos] += self.getObservationProb(observation, pacmanPos, partPos, jailPos)
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for partPos in self.particles:
            ...
            for i in range(self.numGhosts):   
                ...
                probProduct *= self.getObservationProb(observation[i], pacmanPos, partPos[i], jailPos)
